...
/**
 * @author Ray:
 * @version 2017年7月11日 下午8:51:35 类说明 :帖子中的回复的实体类
 */
public class Reply {
	// 文章回复属性
	private int replyId;
	...
	public String toString() {
		return "Reply [replyId=" + replyId + ", replyPostId=" + replyPostId + ", replyUserName=" + replyUserName
				+ ", replyContent=" + replyContent + ", replyGoodCount=" + replyGoodCount + ", replyBadCount="
				+ replyBadCount + ", replyCreateTime=" + replyCreateTime + "]";
	}
}
