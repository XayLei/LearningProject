...
/**
 * @author Ray:
 * @version 2017年7月11日 下午8:50:04 类说明 :帖子实体类
 */
public class Post {
	// 文章属性
	...
	private List<Reply> replies; // 每个帖子都有一个回复列表属性
	...
	public String toString() {
		return "Post [postId=" + postId + ", postBoardId=" + postBoardId + ", postUserName=" + postUserName
				+ ", postTitle=" + postTitle + ", postContent=" + postContent + ", postGoodCount=" + postGoodCount
				+ ", postBadCount=" + postBadCount + ", postViewCount=" + postViewCount + ", postReplyCount="
				+ postReplyCount + ", postStatus=" + postStatus + ", postCreateTime=" + postCreateTime
